  ...
  if (loading) {
    return (
      <div className="flex min-h-[60vh] flex-1 items-center justify-center">
        <p className="text-[13px] tracking-[-0.25px] text-kumo-subtle"><Trans>Loading profile…</Trans></p>
      </div>
    )
  }
  ...
  return (
    <div className="mx-auto flex h-full w-full max-w-2xl flex-col px-4 pb-16 sm:px-10">
      <header className="px-1 pb-2 pt-6 sm:pt-10">
        <h1 className="text-2xl font-semibold tracking-tight text-kumo-default"><Trans>Profile</Trans></h1>
        <p className="mt-1 text-[13px] leading-[18px] tracking-[-0.25px] text-kumo-subtle">
          <Trans>Manage your account details, avatar, and security.</Trans>
        </p>
      </header>
      ...
      <div className="mt-6 flex flex-col gap-9">
        ...
        <section className="flex flex-col gap-3">
          <SectionLabel><Trans>Account</Trans></SectionLabel>
          <div className="divide-y divide-kumo-line overflow-hidden rounded-xl border border-kumo-line bg-kumo-base">
            ...
            <div className="flex items-center gap-4 px-5 py-4">
              ...
              >
                {displayAvatarUrl ? (
                  <img src={displayAvatarUrl} alt={t`Avatar`} className="h-full w-full object-cover" />
                ) : (
              ...
              <div className="min-w-0">
                ...
                <p className="mt-0.5 text-[12px] leading-4 tracking-[-0.2px] text-kumo-subtle">
                  <Trans>Click the avatar to upload a new photo</Trans>
                </p>
              </div>
            </div>
            ...
            <div className="flex items-end gap-2 px-5 py-4">
              <div className="min-w-0 flex-1">
                <FieldLabel><Trans>Display name</Trans></FieldLabel>
                {isEditingName ? (
                  <input
                    value={nameInput}
            ...
            <div className="flex items-center gap-2 px-5 py-4">
              <div className="min-w-0 flex-1">
                <FieldLabel><Trans>User ID</Trans></FieldLabel>
        ...
        {!CF_ACCESS_MODE && hasPassword === true && (
          <section className="flex flex-col gap-3">
            <SectionLabel><Trans>Security</Trans></SectionLabel>
              ...
              <div className="flex max-w-sm flex-col gap-4">
                ...
                <div className="pt-1">
                  ...
                  >
                    ...
                    {passwordLoading ? t`Changing…` : t`Change password`}
                  </button>
                </div>
              </div>
            </div>
