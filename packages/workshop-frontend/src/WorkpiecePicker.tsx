  ...
  return (
    ...
    >
      <button
        ...
        title={expanded ? t`Collapse outputs` : t`Expand outputs`}
        aria-label={expanded ? t`Collapse outputs` : t`Expand outputs`}
      ...
      >
        {expanded && (
          <span className="text-[11px] font-medium uppercase tracking-[0.06em]"><Trans>Outputs</Trans></span>
        )}
      ...
      <div className="flex flex-1 flex-col gap-0.5 overflow-y-auto overflow-x-hidden px-1.5 pb-2">
            ...
            >
              ...
              {expanded && (
                <WorkshopIconButton
                  ...
                  title={t`Rename gadget`}
                  aria-label={t`Rename ${gadget.title}`}
                >
        ...
        <Tooltip content={t`View activity`} asChild>
          <button
            type="button"
          ...
          >
            ...
            {expanded && <span className="min-w-0 flex-1 truncate"><Trans>View activity</Trans></span>}
            {expanded ? (
